              ...
              <div className="px-6">
                <a href="#">
                  ...
                  <div className=" flex flex-col justify-center shrink-0 text-white ml-20">
                    ...
                    <span
                      className="text-xs font-semibold tracking-[4px] uppercase text-white"
                      style={{ color: "#C4A060" }}
                    >
              {t.nav.restaurant}
                    </span>
            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
              <div className=" text-white grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                <div className="flex flex-col space-y-2">
                  <h3 className=" uppercase font-semibold text-[#C4A060] ">{t.footer.navigation}</h3>
                  <div className="flex flex-col space-y-2">
                    <Link
                to="/About"
                    ...
                    <Link to="/Carte" className="block mt-2 text-sm  hover:underline">
                      {t.footer.laCarte}
                    </Link>
                    <Link to="/Galerie" className="block mt-2 text-sm  hover:underline">
                      {t.footer.galerie}
                    </Link>
                    <Link to="/FAQ" className="block mt-2 text-sm  hover:underline">
                      {t.footer.faq}
                    </Link>
                    <Link to="/Contact" className="block mt-2 text-sm  hover:underline">
                      {t.footer.contact}
                    </Link>
                  </div>
                </div>
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <span className="block mt-2 text-sm  hover:underline">
                    75004 Paris, France Île de la Cité
                  </span>
